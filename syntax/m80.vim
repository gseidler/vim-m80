...
" Directives
syn keyword m80Direct   aseg common cseg db dc ds dseg dw end entry public
syn keyword m80Direct   equ ext extrn include name org page set subttl title
syn keyword m80Direct   .printx .radix .z80 .8080 .request .phase .dephase
syn keyword m80Direct   if ift ife iff if1 if2 ifdef ifndef ifb ifnb ifidn ifdif else endif
syn keyword m80Direct   .list .xlist .sfcond .lfcond .tfcond .lall .sall .xall
syn keyword m80Direct   cond endc eject defb defs defw defm defl global external
